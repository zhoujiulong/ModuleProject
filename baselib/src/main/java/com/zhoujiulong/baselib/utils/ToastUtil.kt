...
object ToastUtil {
    ...
    fun toast(msg: String, time: Int = Toast.LENGTH_SHORT) {
        if (mToast == null) {
            val v =
                LayoutInflater.from(ContextUtil.getContext()).inflate(R.layout.layout_toast, null)
    ...
    fun showSuccess(msg: String) {
        val v =
            LayoutInflater.from(ContextUtil.getContext()).inflate(R.layout.layout_state_toast, null)
